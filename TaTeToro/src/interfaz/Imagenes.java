...
// despues decidir si hacer esta clase static o public
	...
	Imagenes() {
		...
		botonElegir = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/botonElegir1.png"));
		botonGuardar = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/botonGuardar.png"));
		botonSi = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/botonSi.png"));
		botonNo = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/botonNo.png"));
//-------------------------------------
		...
		ImagenJ1 = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/clipart1853715.png"));
		ImagenJ2 = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/clipart1853715.png"));
		fondoUsuarios = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/fondoUsuarios.gif"));
		fondoSalida = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/backgroundInternalFrame1.png"));
		instrucciones = new ImageIcon(Imagenes.class.getResource("/imagenesDelFondo/instrucciones1.png"));
